...
<h3 className='aboutMe'>Enthusiastic, eager to learn new things and a creative thinker. I am an undergraduate student studying Computer Science in Aalto University. I share a passion for creating new things.
</h3>
...
<h3 className="sqaurewarsprojektiEsittely">I made a IOS application using swift.</h3>
</a>
</div>
<div className='personalWebsiteEsittelyDiffi'>
<a href="https://github.com/Jaakkosa/personalwebsite" target="_blank" className='personalWebsiteLinkki'>
